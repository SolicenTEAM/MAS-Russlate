# SolicenTEAM - Команда Солицена
## Наши права
Все права на мод «Monika After Story» принадлежат его создателям, [«Команда Солицена»](https://github.com/SolicenTEAM) не пытается присвоить себе права на мод, она лишь его переводит, если у вас есть сомнения, обратитесь по контактам в README организации. 

## Для остальных переводчиков
...
## Для чего это всё
Данный репозиторий служит площадкой для выражения своих переводческих навыков энтузиастов всех мастей и уровней, мы привествуем каждого кто захочет сделать вклад в наш перевод.

Каждый, кто внесет вклад, будет увековечен на странице перевода, в репозитории (тут) и в файлах перевода.
